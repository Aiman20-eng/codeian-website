  ...
  return (
    <div dir="rtl">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
        <div>
          <h1 className="text-3xl font-black text-white">إدارة المشاريع</h1>
          <p className="text-zinc-400 mt-1">عرض وتعديل وحذف مشاريع الفريق</p>
        </div>
        <Link
      ...
      <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl overflow-hidden overflow-x-auto">
        <table className="w-full text-right">
          <thead className="bg-zinc-800/50 border-b border-zinc-800">
            <tr>
              <th className="px-6 py-4 text-zinc-300 font-bold">المشروع</th>
              <th className="px-6 py-4 text-zinc-300 font-bold">التصنيف</th>
              <th className="px-6 py-4 text-zinc-300 font-bold">تاريخ الإضافة</th>
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-zinc-500 text-xs">{project.slug}</div>
                    </div>
                  </div>
                </td>
                <td className="px-6 py-4">
